...
inline Vector3D operator * ( const Matrix4x4& a, const Vector3D& b )
{
  return Vector3D ( a.m [0][0]*b.x + a.m [1][0]*b.y + a.m [2][0]*b.z + a.m [3][0],
                    a.m [0][1]*b.x + a.m [1][1]*b.y + a.m [2][1]*b.z + a.m [3][1],
                    a.m [0][2]*b.x + a.m [1][2]*b.y + a.m [2][2]*b.z + a.m [3][2] ) / (a.m [0][3]*b.x + a.m [1][3]*b.y + a.m [2][3]*b.z + a.m [3][3]);
}
