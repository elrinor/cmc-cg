...
float CVector::operator*(CVector &vec)
{
...
CVector CVector::operator|(CVector &vec)
{
	return CVector(v[1]*vec.v[2]-v[2]*vec.v[1], -(v[0]*vec.v[2]-v[2]*vec.v[0]), v[0]*vec.v[1]-v[1]*vec.v[0]);
}
...
CVector& CVector::Normalize(float n)
{
